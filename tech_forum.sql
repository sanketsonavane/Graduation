...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2018 at 06:28 AM
...
(42, 0, '14', '1.ready\r\n2.running\r\n3.wait\r\n4.block\r\n5.release', '2012-04-26 12:56:15', 8, 11),
(44, 0, '41', 'THIS HAS FIVE STAPE', '2012-04-27 06:06:41', 8, 2),
(45, 0, '39', 'ddddddddd', '2015-10-25 07:11:16', 8, 0),
(46, 0, '39', 'dfdfdf', '2015-10-25 07:11:31', 8, 0),
(47, 0, '42', 'Rasmus Lerdorfffffffff', '2015-10-25 07:12:40', 8, 4),
(48, 8, '41', 'This is threading ans', '2018-01-07 18:01:00', 8, 0),
(49, 8, '41', 'This is threading ans', '2018-01-07 18:02:00', 8, 0),
(50, 8, '41', 'This is my ans of threading', '2018-01-07 18:02:36', 8, 0),
(51, 8, '16', 'This is star topology ans', '2018-01-07 18:08:04', 8, -1),
(52, 8, '25', 'This is the ans of thread', '2018-01-14 04:59:48', 8, 0),
(53, 8, '43', 'You can use mysqli_connect function', '2018-01-18 18:21:04', 8, 0),
(54, 8, '14', 'This is ans of threading question', '2018-01-20 08:58:26', 8, -6),
(55, 32, '17', 'idk', '2018-01-20 10:30:20', 32, 0),
(56, 32, '17', 'king', '2018-01-20 10:31:37', 32, 1),
(57, 32, '14', 'I am the one!', '2018-01-20 10:32:51', 32, 0),
(58, 8, '14', 'hello welcome', '2018-01-21 06:20:49', 8, 0),
(59, 8, '14', 'h  es g ', '2018-01-21 06:21:23', 8, 0),
(60, 8, '14', 'nj bjb jjbjb jbjb', '2018-01-21 06:21:37', 8, 0),
(61, 8, '17', 'hvjh  hj j kghb', '2018-01-21 06:22:05', 8, 0),
(62, 32, '17', 'y rd  iu', '2018-01-21 06:23:32', 32, 0),
(63, 32, '17', 'no i cant', '2018-01-21 06:23:51', 32, 0);
...
(1200, '2018-01-19', 'kadir', 'kadir@gmail.com', '1236547890', 'Heloooooo');
...
(7, 'table connectivity', 'query of the connecting table with form?', '2012-04-11 09:42:44', 8, 7, 15),
(8, 'Window Xp', 'how to debbuge the ble screen error?', '2012-04-11 00:25:00', 8, 5, 2),
(9, 'Window vista', 'hot to change the administrator password from cmd?', '2012-04-03 17:51:44', 8, 5, 2),
(10, 'Window 7', 'how to make uninstall set up? ', '2012-04-05 02:24:42', 8, 5, 4),
(11, 'linux', 'how to use the live source of l\r\n', '2012-04-07 00:51:42', 9, 5, 6),
(12, 'connectivity', 'how to connect form with database?', '2012-04-09 09:01:36', 8, 2, 10),
(14, 'Thread life cycle', 'What are the different stages of thread life cycle?\r\n', '2012-04-09 23:04:43', 9, 12, 239),
(15, 'applet controls ', 'how to create simple applet program? ', '2012-04-12 12:02:44', 9, 13, 6),
(16, 'STAR topology', 'how connection established in the star topology?\r\n', '2012-04-26 22:14:01', 9, 17, 12),
(17, 'Scheduling', 'Hello,\r\n\r\nI want to create a program that supports multi-threading with scheduling. The program must', '2012-04-17 15:41:54', 8, 12, 94),
...
(25, 'thread ', 'explain the  various stages of thread', '2012-04-22 05:39:06', 8, 12, 8),
(29, 'what', 'what is what', '2012-04-24 14:18:15', 28, 12, 7),
(30, 'What is thread ?', 'What is thread ?', '2012-04-24 14:38:03', 29, 12, 1),
(31, 'window 7', 'Windows 7, how can I open .jnlp extension in Internet Explorer 9?', '2012-04-25 13:25:05', 8, 12, 6),
(32, 'window vista', 'Unable to see taskbar notifications in Windows Vista SP2?', '2012-04-25 13:26:24', 8, 12, 6),
...
(40, 'Connection speed', 'How to increase the speed of your broadband connection?', '2012-04-25 14:53:08', 9, 20, 5),
(41, 'THREADING', 'WHAT IS THREADING?', '2012-04-27 06:05:09', 32, 12, 28),
(42, 'Who is the father of php', 'Any one tell me who is the father of php ???????', '2015-10-25 07:12:11', 8, 12, 18),
(45, 'Thread ', 'What is thread Exception?', '2018-01-20 09:02:49', 8, 12, 0),
(46, 'Thread  exception abc', 'this is random question?', '2018-01-20 09:04:24', 8, 12, 2);
...
INSERT INTO `user` (`user_id`, `country`, `state`, `address`, `user_type`, `username`, `fullname`, `password`, `user_acc_active`, `dob`, `e_mail`, `gender`, `uimg`, `isuser`, `score`) VALUES
(5, 'U.S.A', 'ahmedabad', 'Station', 'admin', 'admin', 'administrator', 'admin', NULL, '2012-04-17', 'admin@gmail.com', '1', 'pratik.jpg', 1, 0),
(8, 'India', 'Maharashtra', 'Station', 'user', 'hardik', 'hardik patel', '123', NULL, '1992-06-15', 'hardik@gmail.com', '1', 'ups/akshay.jpg', 0, 7),
(9, 'India', 'Gujarat', 'mahesana', 'user', 'fabin', 'Christian Fabin Mathew', 'fabinlj', NULL, '0000-00-00', 'fabin.christian@gmail.com', '1', 'ups/124.jpg', 0, 0),
(12, 'India', 'Gujarat', 'sant lilashah soc,bhargav soc,Ahmedabad', 'user', 'Vikas ', 'Vikas Patel', 'vikas', NULL, '1990-04-03', 'vikas.patel@gmail.com', '1', 'ups/1.jpg', 0, 0),
(15, 'India', 'Gujarat', 'porbandar', 'user', 'mahesh', 'mahesh narvani', 'm', NULL, '1990-04-27', 'mahesh.narvani@gmail.com', '1', 'ups/Pink Rose For You-504352.jpeg', 0, 0),
(27, 'India', 'Gujarat', '13-yamuna tenament,near bhargav soc.,kuber nagar ,bunglow area  ', 'user', 'Jasmin', 'Jasmin Patel', 'jasmin', NULL, '1986-11-25', 'jasmin.patel@gmail.com', '1', 'ups/7.jpg', 1, 0),
(28, 'India', 'Gujarat', 'gdhjsbb', 'user', 'rushabh', 'rushabh joshi', 'rest', NULL, '0000-00-00', 'rushabh.joshi@gmail.com', '1', 'ups/', 0, 0),
(30, 'j', 'j', 'j', 'user', 'Mehul', 'Mehul Varia', '123', NULL, '1986-11-25', 'ms.mainframe@gmail.com', '1', 'ups/1.jpg', 0, 0),
(31, 'India', 'Gujarat', 'jamnagar', 'user', 'satish', 'Satish Babariya', 'satish', NULL, '0000-00-00', 'satish.babariya@gmail.com', '1', 'ups/Red Roses Love-262228.jpeg', 0, 0),
(32, '-', '-', '-', 'user', 'abc', 'a', '123', NULL, '1986-11-25', 'ab@gmail.com', '1', 'ups/Colorized Heart-733225.jpeg', 1, -2.5);
