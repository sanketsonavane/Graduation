...
$m=$row4['like']+1;
mysql_query("UPDATE `answer` SET `like` = '$m' WHERE answer.answer_id =$r") or die(mysql_error());
mysql_query("UPDATE `user` SET `score` = `score` + 1.5 WHERE user_id=$_SESSION[uid]") or die(mysql_error());
