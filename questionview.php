...
<?php
	...
	{	
		...
		{			
			echo "<span class='box2'>";
			echo "<span class='head'><a href='answer.php?id=$_GET[qid]'>REPLY</a><p class='view2'>$row1[like]</p>";			
			if(!stripos($row1["liked"],$_SESSION['uid'])!==false)				
			{	
				echo "
				<a href='like.php?id=$row1[answer_id] ' class='view2' >Like </a>
				<a href='dislike.php?id=$row1[answer_id] ' class='view2' >Dislike </a>";
			}
			echo "
			<a href='dwdpap.php?id=$_GET[qid]' class='view2'>Download</a></span>";
