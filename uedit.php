...
$sql="SELECT * from user where user_id=$_SESSION[uid]";
	...
	if (mysql_num_rows($rows)>0)
	{
		...
		echo "<table>";
		echo "<tr><td>User Name</td><td> : </td><td><input type='text' class=form-control name='un' value='$row[username]' ><span id='a' style='color: red';/></span></td></tr>";
		...
		echo "<tr><td>Password</td> <td> : </td><td><input type='text' class=form-control name='pwd' value='$row[password]'><span id='c' style='color: red';/></span></td></tr>";
		...
		echo "<tr><td>Image</td><td>:</td><td> <input type='file' class=form-control name='ima' value=''/></td></tr> ";
		echo "<tr><td>Address</td><td> :</td><td> <input type=text class=form-control name='add' value='$row[address]'><span id='i'  style='color: red';/></span></td></tr>";
		...
		echo "<tr><td>Country</td><td> :</td><td><input type='text' class=form-control name='cou' value='$row[country]'><span id='k' style='color: red';/></span></td></tr>";
		echo "</table>";	
	}
